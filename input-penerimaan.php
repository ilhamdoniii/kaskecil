...
<form action="penerimaan-simpan.php" name="form" method="POST" enctype="multipart/form-data">
  <h1>Input Data Penerimaan PattyCash</h1>
    ...
    <fieldset id="UserDataFields">
        ...
        <div class="control-group">
            ...
            <?php
                    include "koneksi.php";
                    $cek = mysqli_num_rows(mysqli_query($konek, "select * from penerimaan_kk WHERE nm_penerimaan='PattyCash'"));
                      if ($cek == 0){
                        echo "value='PattyCash'";
                      }else{
